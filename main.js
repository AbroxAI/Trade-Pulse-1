(function() {
  ...
  let allTransactions = [
    ...
    // 8 additional realistic withdrawals (total now 14)
  ...
  function fmt(amount, isUSDT = false) {
    if (isUSDT) {
      return amount.toLocaleString('en', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' USDT';
    }
  ...
  function addTransaction(type, amount, subtitle, meta, currency=null, iconType=null) {
    ...
    tx.id = allTransactions.length + 1; // assign new unique ID
  ...
  // Delegate click for withdrawal rows
