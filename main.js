(function() {
  ...
  function updateAvatarDisplay(dataUrl) {
    ...
    const initialNode = getAvatarInitialNode();
  ...
  // ========== REMOVED LOGOUT HANDLER (now in index.html modal) ==========
  // Logout is handled by the inline script in index.html
