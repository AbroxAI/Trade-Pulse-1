(function() {
  ...
  const base = {
    ...
    txFee: FEE,
    activePlans: 3,
    planMin1: 10000,          // Beginner now starts at ₦10,000
    planMax1: 49999,
    planMin2: 50000,
    planMax2: 199999,
    planMin3: 200000,
  ...
  // ★ NEW CHART – smooth growth to ₦621,435
  let chartData = [
  ...
  // ★ NEW TRANSACTIONS – withdrawals start Feb 16, consistent totals
  let allTransactions = [
  ...
  document.querySelectorAll('.invest-now-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      const min = plan==='beginner'?10000:plan==='standard'?50000:plan==='premium'?200000:500000; // beginner min 10k
      const rate = plan==='beginner'?3.0:plan==='standard'?3.5:plan==='premium'?4.0:4.5; // UPDATED RATES
  ...
  // Dynamically update drawer name to the stored username
