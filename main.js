(function() {
  ...
  // Copy Referral Link (not just code)
  ...
  // Wallet action clicks (main action buttons)
  document.body.addEventListener('click', e => {
    ...
    // Handle small-action buttons inside wallet accounts
  ...
  // --- Settings modal – dynamic interaction ---
  // Push toggle
