(function() {
  ...
  function getIconSVG(type) {
    ...
    // added wallet/transfer icon to fix white dot
  ...
  // Chart – fixed label cut-off and now scrollable
  function buildChart() {
  ...
  // Chart auto‑update only when Home view is active – prevents glitching
  setInterval(()=>{
  ...
  // Render functions – removed extra SVG dots to fix alignment
